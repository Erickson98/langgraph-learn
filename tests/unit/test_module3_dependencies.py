"""Tests for module 3 dependency helpers."""
...
class Module3DependencyTests(unittest.TestCase):
    """Verify module 3 model and provider configuration helpers."""
    ...
    def test_get_chat_model_uses_langchain_initializer(self) -> None:
        ...
        with patch("app.module3.dependencies.init_chat_model") as init_chat_model:
