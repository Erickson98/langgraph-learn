"""Tests for module 5 dependency helpers."""
...
class Module5DependencyTests(unittest.TestCase):
    """Verify module 5 model and provider configuration helpers."""
    ...
    def test_get_chat_model_uses_langchain_initializer(self) -> None:
        ...
        with patch("app.module5.dependencies.init_chat_model") as init_chat_model:
