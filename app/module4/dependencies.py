"""Dependency setup for the module 4 research brief workflow."""
...
from app.module4.schemas import DEFAULT_MODEL, DEFAULT_MODEL_PROVIDER, ChatModelConfig

if TYPE_CHECKING:
    from app.module4.services.module_service import Module4Service
...
def get_chat_model(
    ...
    """Build the chat model used by the module 4 graph.
...
def get_module4_service(
    settings: Annotated[Settings, Depends(get_settings)],
) -> "Module4Service":
    """Build the module 4 application service for FastAPI injection.
