"""Dependency setup for the module 3 breakpoint workflows."""
...
if TYPE_CHECKING:
    from app.module3.services.module_service import Module3Service
...
def get_chat_model(
    ...
    """Build the chat model used by the module 3 graphs.
...
def get_module3_service(
    settings: Annotated[Settings, Depends(get_settings)],
) -> "Module3Service":
    """Build the module 3 application service for FastAPI injection.

    Args:
        settings: Runtime settings injected by FastAPI.

    Returns:
        Module 3 application service.
    """
    from app.module3.services.module_service import Module3Service
